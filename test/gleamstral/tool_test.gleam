...
import gleamstral/tool.{Function, FunctionCall, ToolCall}
...
pub fn tool_encoder_test() {
      ...
      parameters: json_schema.object([
        json_schema.field(
          ...
          json_schema.String(
            ...
            nullable: False,
            title: None,
            description: Some("The city and state"),
            deprecated: False,
          ),
        ),
        json_schema.optional_field(
          ...
          json_schema.String(
            ...
            nullable: False,
            title: None,
            description: Some("The temperature unit"),
            deprecated: False,
          ),
        ),
      ]),
  ...
  assert json.to_string(result) == json.to_string(expected)
